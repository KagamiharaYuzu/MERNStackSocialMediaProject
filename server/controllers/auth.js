...
export const register = async (req, res) => {
    try {
        ...
        const newUser = new User({
            firstName, lastName, email, passHash, picturePath, friends, location, occupation, profileViews: Math.floor(Math.random() * 10000), impressions: Math.floor(Math.random() * 10000)
        });
